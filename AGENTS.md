...
- Before making changes, run the following locally:
...
- Skills live in `.agents/skills/vercel-composition-patterns/`
- Rules live in `.agents/skills/vercel-composition-patterns/rules/`
